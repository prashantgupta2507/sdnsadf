...
export default function AddAddress() {
    ...
    const {addNewAddress,updateAddrComState} = bindActionCreators(addressActionCreators,dispatch)
    ...
    const handleFormSubmit = async (e) => {
      ...
      try {
        await axios.post("http://localhost:5500/api/user/address/add-address", newAddressInputs);
        addNewAddress(newAddressInputs);
        toastMessage("New Address added", "success");
        updateAddrComState(false);
      ...
      <Box className={classes.component}>
        ...
        <form onSubmit={handleFormSubmit}>
          ...
          <span
            ...
            onClick={() => updateAddrComState(false)}
          >
            Cancel
          </span>
        </form>
